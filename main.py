        ...
        <foreignObject width="100%" height="100%">
            <div xmlns="http://www.w3.org/1999/xhtml">
                <style>
                    .fortune-card {{
                        width: 450px; 
                        height: 300px; /* 검은 박스 높이를 전체 SVG 높이와 맞췄습니다 */
                        background: #1a1a1a;
                        border-radius: 24px; 
                        padding: 30px; /* 상하좌우 여백을 균일하게 줬습니다 */
                        color: #f5f5f5;
                    ...
                    .title {{ font-size: 15px; color: #f0f6fc; font-weight: 600; }}
